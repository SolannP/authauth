...
public class UnitTestAccount
{
    ...
    public void EqualityOfAccount()
    {
        ...
        Assert.IsTrue(new Account(randomLogin, randomPassword).Equals(new Account(randomLogin, randomPassword)));

        Assert.That(new Account(randomLogin, randomPassword), Is.Not.EqualTo(new Account(anotherLogin, anotherPassword)));

        Assert.That(new Account(randomLogin, randomPassword), Is.Not.EqualTo(new Account(randomLogin, anotherPassword)));

        Assert.That(new Account(randomLogin, randomPassword), Is.Not.EqualTo(new Account(anotherLogin, randomPassword)));
    }
    ...
    public void GetAllAccount()
    {
        ...
        Assert.That(allAccounts.Where(account => account!.Contact.Equals(firstLogin)), Is.Not.Null);
        Assert.That(allAccounts.Where(account => account!.Contact.Equals(thridLogin)), Is.Not.Null);

        Assert.Pass($"Data : {JsonConvert.SerializeObject(allAccounts)}");
    }
